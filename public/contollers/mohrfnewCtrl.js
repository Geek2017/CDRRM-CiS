angular.module('newApp').controller('mohrfnewCtrl', function($scope) {
    pageSetUp();
    var obj;
    var obj2;
    ...
    $('#newcf').on('submit', function(e) {
        ...
        var uid = firebase.database().ref().child('barangay/mohrf').push().key;
        var orno = $scope.ornum;
        var sector = $scope.sector;
        var barangayEvacuated = $scope.barangayEvacuated;
        var evacCenterNo = $scope.evacCenterNo;
        ...
        var data = {
            date: datetoday,
            barangayEvacuated: barangayEvacuated,
            evacCenterNo: evacCenterNo,
            family: withoutLast2,
            family2: withoutLast3
        }

        var updates = {};
        updates['/barangay/mohrf/'  + uid] = data;
