angular.module('newApp').controller('cnsbdcdrrmonewCtrl', function($scope) {
    pageSetUp();
    var obj;
    ...
    $('#newcf').on('submit', function(e) {
        ...
        var uid = firebase.database().ref().child('/cdrmo/cnsbd').push().key;
