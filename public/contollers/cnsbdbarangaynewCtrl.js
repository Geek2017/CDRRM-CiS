angular.module('newApp').controller('cnsbdbarangaynewCtrl', function($scope) {
    pageSetUp();
    var obj;
    ...
    $('#newcf').on('submit', function(e) {
        ...
        var uid = firebase.database().ref().child('/barangay/cnsbd').push().key;
        ...
        var updates = {};
        updates['/barangay/cnsbd/' + uid] = data;
        ...
        if (updates) {
            ...
            setTimeout(function() {
                ...
                window.location.href = "#cnsbdbarangaynew"
            }, 1500);
        } else {
